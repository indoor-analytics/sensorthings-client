...
describe('Datastream', () => {
    ...
    it ('should throw when created with empty phenomenon time', () => {
        const create = () => new Datastream(
            service, 'name', 'description',
            unitOfMeasurement, ObservationType.OM_CategoryObservation, area,
            "",
        ...
        expect(create).toThrowError(new RangeError('"" is not a valid phenomenonTime value.'));
    });

    it ('should throw when created with empty result time', () => {
        const create = () => new Datastream(
            service, 'name', 'description',
            unitOfMeasurement, ObservationType.OM_CategoryObservation, area,
            "2014-03-01T13:00:00Z/2015-05-11T15:30:00Z",
        ...
        expect(create).toThrowError(new RangeError('"" is not a valid resultTime value.'));
    });
    ...
    it('should not create an instance with unit.name null only', () => {
        const create = () => new Datastream(
            service, 'name', 'description',
            {name: null, definition: 'def', symbol: 'S'}, // unitOfMeasurement
            ObservationType.OM_CategoryObservation, area,
            "2014-03-01T13:00:00Z/2015-05-11T15:30:00Z",
            "2014-03-01T13:00:00Z/2015-05-11T15:30:00Z"
        );
    ...
    it('should not create an instance with unit.definition null only', () => {
        const create = () => new Datastream(
            service, 'name', 'description',
            {name: 'name', definition: null, symbol: 'S'}, // unitOfMeasurement
            ObservationType.OM_CategoryObservation, area,
            "2014-03-01T13:00:00Z/2015-05-11T15:30:00Z",
            "2014-03-01T13:00:00Z/2015-05-11T15:30:00Z"
        );
